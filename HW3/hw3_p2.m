...
[tx_o2_orig, xn_o2_orig] = orb_o2_orig.propagate_simple_kepler();
...
% Print Out Verification Output
fprintf("IOD Initial Condition Verification [J2000]: Obervation 1\n\n")
fprintf("ISS OEM: X: %.5fkm, Y: %.5fkm, Z: %.5fkm\n", xn_o1_orig(1,1), ...
                                                xn_o1_orig(1,2), ...
                                                xn_o1_orig(1,3))
fprintf("ISS OEM: V1: %.5fkm/s, V2: %.5fkm/s, V3: %.5fkm/s\n\n", xn_o1_orig(1,4), ...
                                                xn_o1_orig(1,5), ...
                                                xn_o1_orig(1,6))
fprintf("GAUSS IOD: X: %.5fkm, Y: %.5fkm, Z: %.5fkm\n", xn_o1_gauss(1,1), ...
                                                xn_o1_gauss(1,2), ...
                                                xn_o1_gauss(1,3))
fprintf("GAUSS IOD: V1: %.5fkm/s, V2: %.5fkm/s, V3: %.5fkm/s\n\n", xn_o1_gauss(1,4), ...
                                                xn_o1_gauss(1,5), ...
                                                xn_o1_gauss(1,6))
fprintf("GIBBS IOD: X: %.5fkm, Y: %.5fkm, Z: %.5fkm\n", xn_o1_gibbs(1,1), ...
                                                xn_o1_gibbs(1,2), ...
                                                xn_o1_gibbs(1,3))
fprintf("GIBBS IOD: V1: %.5fkm/s, V2: %.5fkm/s, V3: %.5fkm/s\n", xn_o1_gibbs(1,4), ...
                                                xn_o1_gibbs(1,5), ...
                                                xn_o1_gibbs(1,6))
fprintf("\n----------------------------------------------------------\n")

% Observation 2
fprintf("IOD Initial Condition Verification [J2000]: Obervation 2\n\n")
fprintf("ISS OEM: X: %.5fkm, Y: %.5fkm, Z: %.5fkm\n", xn_o2_orig(1,1), ...
                                                xn_o2_orig(1,2), ...
                                                xn_o2_orig(1,3))
fprintf("ISS OEM: V1: %.5fkm/s, V2: %.5fkm/s, V3: %.5fkm/s\n\n", xn_o2_orig(1,4), ...
...
% Obs 1 Errors
x0_residual_gibbs_o1 = xn_o1_gibbs(1, 1:3) - xn_o1_orig(1,1:3); 
x0_residual_gauss_o1 = xn_o1_gauss(1, 1:3) - xn_o1_orig(1,1:3);
v0_residual_gibbs_o1 = xn_o1_gibbs(1, 4:6) - xn_o1_orig(1,4:6);
v0_residual_gauss_o1 = xn_o1_gauss(1, 4:6) - xn_o1_orig(1,4:6);

% Obs 2 Errors
x0_residual_gibbs_o2 = xn_o2_gibbs(1, 1:3) - xn_o2_orig(1,1:3); 
x0_residual_gauss_o2 = xn_o2_gauss(1, 1:3) - xn_o2_orig(1,1:3);
v0_residual_gibbs_o2 = xn_o2_gibbs(1, 4:6) - xn_o2_orig(1,4:6);
v0_residual_gauss_o2 = xn_o2_gauss(1, 4:6) - xn_o2_orig(1,4:6);

fprintf("IOD Initial Condition Residual Norms [J2000]: Observation 1\n\n")
fprintf("ISS OEM vs. GIBBS: Position Residual: %.5f km, Velocity Residual: %.5f km/s \n", ...
         norm(x0_residual_gibbs_o1), norm(v0_residual_gibbs_o1))
fprintf("ISS OEM vs. GAUSS: Position Residual: %.5f km, Velocity Residual: %.5f km/s \n", ...
         norm(x0_residual_gauss_o1), norm(v0_residual_gauss_o1))

fprintf("\n----------------------------------------------------------\n")

fprintf("IOD Initial Condition Residual Norms [J2000]: Observation 2\n\n")
fprintf("ISS OEM vs. GIBBS: Position Residual: %.5f km, Velocity Residual: %.5f km/s \n", ...
         norm(x0_residual_gibbs_o2), norm(v0_residual_gibbs_o2))
fprintf("ISS OEM vs. GAUSS: Position Residual: %.5f km, Velocity Residual: %.5f km/s \n", ...
         norm(x0_residual_gauss_o2), norm(v0_residual_gauss_o2))
